...
DEFAULT_DETAIL_OUTPUT = (
    "research_results/"
    "donchian_ablation_detail.csv"
)

DEFAULT_SUMMARY_OUTPUT = (
    "research_results/"
    "donchian_ablation_summary.csv"
)

DEFAULT_WINNER_OUTPUT = (
    "research_results/"
    "donchian_ablation_symbol_winners.csv"
)

DEFAULT_WIN_COUNT_OUTPUT = (
    "research_results/"
    "donchian_ablation_win_summary.csv"
)
...
def benchmark_donchian_ablation(
    *,
    symbols: list[str],
    start_date: str | None,
    end_date: str | None,
