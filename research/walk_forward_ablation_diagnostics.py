...
DEFAULT_DETAIL_OUTPUT = (
    "research_results/"
    "ablation_oos_detail.csv"
)

DEFAULT_SUMMARY_OUTPUT = (
    "research_results/"
    "ablation_oos_summary.csv"
)

DEFAULT_WINDOW_WINNER_OUTPUT = (
    "research_results/"
    "ablation_oos_window_winners.csv"
)

DEFAULT_RANKING_OUTPUT = (
    "research_results/"
    "ablation_oos_ranking.csv"
)
...
def run_ablation_diagnostics(
    *,
    ...
    print(
        ...
        f"{len(entry_registry)} entry model(s) "
        f"= {total_evaluations} "
        f"OOS evaluations."
    )
    ...
    print(
        "Exit cố định: "
        f"ATR {atr_stop_multiplier} / "
        f"{atr_target_multiplier}"
    )
